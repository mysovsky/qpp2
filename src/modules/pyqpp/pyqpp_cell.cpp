...
void py_cell_export (py::module m, const char * pyname) { 
  ...
  py::class_<qpp::periodic_cell<REAL>, std::shared_ptr<qpp::periodic_cell<REAL>> >(m, pyname)
      .def(py::init<int>())
      .def(py::init<
           qpp::vector3<REAL> ,
           qpp::vector3<REAL>,
    ...
    .def_property("tol_transl",
		  [](const qpp::periodic_cell<REAL> & self){return *self.tol_transl;},
		  [](qpp::periodic_cell<REAL> & self, REAL v){*self.tol_transl=v;})
    .def_property("tol_rot",
		  [](qpp::periodic_cell<REAL> & self){return *self.tol_rot;},
		  [](qpp::periodic_cell<REAL> & self,REAL v){*self.tol_rot=v;});
...
void pyqpp_cell_export (py::module m) {
  ...
  qpp::gen_cell<double, qpp::rotrans<double> >::py_export(
        m, "crystal_group_d");
  ...
  qpp::genform_group<qpp::matrix3<double> >::py_export(
        m, "genform_point_group_d");
  
  qpp::array_group<qpp::rotrans<double> >::py_export(
  ...
  m.def("generator_form", py_generator_form<double, qpp::rotrans<double>,
	qpp::array_group<qpp::rotrans<double> > >);
