...
void pyqpp_ptable_export(pybind11::module m) {
  ...
  ptablem.def("get_atom_symbol_by_number", &qpp::ptable::symbol_by_number);
  ptablem.def("get_atom_name_by_number", &qpp::ptable::name_by_number);
  ...
  ptablem.def("get_nval_elec_by_number", &qpp::ptable::nval_elec_by_number);
