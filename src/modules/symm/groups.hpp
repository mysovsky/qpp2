...
namespace qpp {
  ...
  */
  ...
  class genform_group {
    public:
    typedef genform_group<TRANSFORM> SELF;
    ...
    TRANSFORM py_getitem(const index & n) const {
      return (*this)(n);
    }

    static void py_export(py::module m, const char * pyname){
      py::class_<genform_group<TRANSFORM>, std::shared_ptr<genform_group<TRANSFORM> > >(m, pyname)
		.def(py::init<const std::vector<TRANSFORM> &, const index &,
	     const index &, const STRING_EX &>(),py::arg("_generators"),
	     py::arg("_begin"), py::arg("_end"), py::arg("_name") = "")
	.def("begin", &SELF::begin)
	.def("end",   &SELF::end)
	.def("__getitem__", &SELF::py_getitem)
	.def("generate", &SELF::generate<std::vector<TRANSFORM>>)
	.def("get_dim", &SELF::get_dim)
	.def("set_dim", &SELF::set_dim)
